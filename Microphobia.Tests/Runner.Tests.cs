...
namespace N17Solutions.Microphobia.Tests
{
    public class RunnerTests
    {
        ...
        {
            // Act
            await _sut.Deregister("Test", "Test", 1).ConfigureAwait(false);
            
            // Assert
            _dataProviderMock.Verify(x => x.DeregisterQueueRunner(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<CancellationToken>()), Times.Once());
        }
